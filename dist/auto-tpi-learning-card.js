 ...
 */
const t=globalThis,e=t.ShadowRoot&&(void 0===t.ShadyCSS||t.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,i=Symbol(),s=new WeakMap;let o=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==i)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const i=this.t;if(e&&void 0===t){const e=void 0!==i&&1===i.length;e&&(t=s.get(i)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),e&&s.set(i,t))}return t}toString(){return this.cssText}};const n=(t,...e)=>{const s=1===t.length?t[0]:e.reduce((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1],t[0]);return new o(s,t,i)},a=e?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return(t=>new o("string"==typeof t?t:t+"",void 0,i))(e)})(t):t,{is:r,defineProperty:h,getOwnPropertyDescriptor:l,getOwnPropertyNames:c,getOwnPropertySymbols:p,getPrototypeOf:d}=Object,_=globalThis,g=_.trustedTypes,u=g?g.emptyScript:"",f=_.reactiveElementPolyfillSupport,m=(t,e)=>t,y={toAttribute(t,e){switch(e){case Boolean:t=t?u:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},x=(t,e)=>!r(t,e),v={attribute:!0,type:String,converter:y,reflect:!1,useDefault:!1,hasChanged:x};
/**
 * @license
 ...
 */class ht extends ${constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const s=i?.renderBefore??e;let o=s._$litPart$;if(void 0===o){const t=i?.renderBefore??null;s._$litPart$=o=new tt(e.insertBefore(E(),t),t,void 0,i??{})}return o._$AI(t),o})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return j}}ht._$litElement$=!0,ht.finalized=!0,rt.litElementHydrateSupport?.({LitElement:ht});const lt=rt.litElementPolyfillSupport;lt?.({LitElement:ht}),(rt.litElementVersions??=[]).push("4.2.2");class ct extends ht{static properties={hass:{type:Object},config:{type:Object},_history:{type:Object},_loading:{type:Boolean},_error:{type:String},_showTemp:{type:Boolean},_showHeating:{type:Boolean},_showSetpoint:{type:Boolean},_showKint:{type:Boolean},_showKext:{type:Boolean},_showExtTemp:{type:Boolean},_showMaxCapacity:{type:Boolean},_lastFetchTime:{type:Number},_lastStartDt:{type:String},_tooltip:{type:Object},_width:{type:Number},_zoomLevel:{type:Number},_panOffset:{type:Number},_isDragging:{type:Boolean},_dragStartX:{type:Number},_dragStartOffset:{type:Number},_yZoomLevel:{type:Number},_yPanOffset:{type:Number},_isYDragging:{type:Boolean},_dragStartY:{type:Number},_dragStartYOffset:{type:Number},_isPinching:{type:Boolean},_pinchStartDist:{type:Number},_pinchStartZoom:{type:Number},_pinchStartYZoom:{type:Number},_resetChecked:{type:Boolean},_boostKintChecked:{type:Boolean},_unboostKextChecked:{type:Boolean},_showOptions:{type:Boolean}};static getConfigElement(){return document.createElement("auto-tpi-learning-card-editor")}static getStubConfig(){return{learning_entity:"",climate_entity:"",name:""}}constructor(){super(),this._history=null,this._loading=!1,this._error=null,this._showTemp=!0,this._showHeating=!0,this._showSetpoint=!0,this._showKint=!0,this._showKext=!0,this._showExtTemp=!0,this._showMaxCapacity=!0,this._lastFetchTime=0,this._lastStartDt=null,this._tooltip=null,this._width=1,this._resizeObserver=null,this._zoomLevel=1,this._panOffset=0,this._isDragging=!1,this._dragStartX=0,this._dragStartOffset=0,this._yZoomLevel=1,this._yPanOffset=0,this._isYDragging=!1,this._dragStartY=0,this._dragStartYOffset=0,this._resetChecked=!1,this._boostKintChecked=!1,this._unboostKextChecked=!1,this._showOptions=!1}connectedCallback(){super.connectedCallback(),this._resizeObserver=new ResizeObserver(t=>{for(let e of t)e.contentRect.width>0&&(this._width=e.contentRect.width)}),this._resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._resizeObserver&&this._resizeObserver.disconnect()}setConfig(t){if(!t.learning_entity)throw new Error("You need to define learning_entity");if(!t.climate_entity)throw new Error("You need to define climate_entity");this.config=t,this._history=null,this._lastFetchTime=0,this._lastStartDt=null}getCardSize(){}getLayoutOptions(){return{}}shouldUpdate(t){return!0}willUpdate(t){(t.has("_width")||t.has("_zoomLevel")||t.has("_panOffset")||t.has("_yZoomLevel")||t.has("_yPanOffset")||t.has("_history"))&&(this._chartState=null,this._staticChartContent=null),(t.has("_showTemp")||t.has("_showHeating")||t.has("_showSetpoint")||t.has("_showKint")||t.has("_showKext")||t.has("_showExtTemp")||t.has("_showMaxCapacity"))&&(this._staticChartContent=null)}updated(t){if(super.updated(t),t.has("hass")&&this.hass&&this.config){const t=this.config.learning_entity,e=this.hass.states[t],i=e?.attributes?.learning_start_dt;if(i&&this._lastStartDt&&i!==this._lastStartDt&&(this._history=null),i&&(this._lastStartDt=i),this._history&&i){const t=new Date(i).getTime();Math.abs(this._history.startTime-t)>1e3&&(this._history=null)}const s=Date.now()-this._lastFetchTime>3e5,o=this._history&&this._history.endTime;(!this._history||s&&!o)&&!this._loading&&this._fetchHistory()}}async _fetchHistory(){if(!this._loading&&this.hass&&this.config){this._loading=!0,this._error=null;try{const t=this.config.learning_entity,e=this.config.climate_entity,i=this.hass.states[t];let s,o=i?.attributes?.learning_start_dt;s=o?new Date(o):new Date(Date.now()-864e5);const n=s.toISOString(),a=(new Date).toISOString(),r=`history/period/${n}?filter_entity_id=${[t,e].join(",")}&end_time=${a}&significant_changes_only=0`,h=await this.hass.callApi("GET",r);this._processHistory(h,t,e,s),this._lastFetchTime=Date.now()}catch(t){console.error("Error fetching history:",t),this._error="Failed to fetch history data."}finally{this._loading=!1}}}_bisectLeft(t,e){let i=0,s=t.length;for(;i<s;){const o=i+s>>>1;t[o].t<e?i=o+1:s=o}return i}_bisectRight(t,e){let i=0,s=t.length;for(;i<s;){const o=i+s>>>1;t[o].t<=e?i=o+1:s=o}return i-1}_getVisibleData(t,e,i){if(!t||0===t.length)return[];let s=this._bisectLeft(t,e),o=this._bisectRight(t,i);return s=Math.max(0,s-1),o=Math.min(t.length-1,o+1),s>o?[]:t.slice(s,o+1)}_processHistory(t,e,i,s){if(!Array.isArray(t))return void(this._history={kint:[],kext:[],temp:[],heating:[],setpoint:[],extTemp:[],maxCapacity:[],startTime:s.getTime()});const o={kint:[],kext:[],temp:[],heating:[],setpoint:[],extTemp:[],maxCapacity:[]};let n=null;const a=(t,e,i)=>{const s=parseFloat(i);isNaN(s)||t.push({t:e,val:s})};for(const s of t){if(!s||0===s.length)continue;const t=s[0].entity_id,r=t===e;if(r||t===i)for(const t of s){const e=new Date(t.last_updated).getTime(),i=t.attributes;if(i)if(r){const s=i.coeff_int_cycles||0,r=i.coeff_ext_cycles||0;"Off"===t.state&&s>=50&&r>=50&&(null===n||e<n)&&(n=e),null!=i.calculated_coef_int&&a(o.kint,e,i.calculated_coef_int),null!=i.calculated_coef_ext&&a(o.kext,e,i.calculated_coef_ext),null!=i.max_capacity_heat&&a(o.maxCapacity,e,i.max_capacity_heat)}else{null!=i.current_temperature&&a(o.temp,e,i.current_temperature),null!=i.temperature&&a(o.setpoint,e,i.temperature);let t=null;null!=i.specific_states?.ext_current_temperature?t=i.specific_states.ext_current_temperature:null!=i.ext_current_temperature&&(t=i.ext_current_temperature),null!=t&&a(o.extTemp,e,t),void 0!==i.hvac_action&&o.heating.push({t:e,val:"heating"===i.hvac_action?1:0})}}}for(const t in o)o[t].sort((t,e)=>t.t-e.t);const r=this.hass.states[e];if(r){const t="Off"===r.state,e=r.attributes.coeff_int_cycles||0,i=r.attributes.coeff_ext_cycles||0;t&&e>=50&&i>=50||(n=null)}this._history={...o,startTime:s.getTime(),endTime:n}}_getLearningData(){const t=this.hass.states[this.config.learning_entity];return t?{state:t.state,kint:parseFloat(t.attributes.calculated_coef_int)||0,kext:parseFloat(t.attributes.calculated_coef_ext)||0,kintCycles:t.attributes.coeff_int_cycles||0,kextCycles:t.attributes.coeff_ext_cycles||0,confidence:parseFloat(t.attributes.model_confidence)||0,status:t.attributes.last_learning_status||"",learningStartDt:t.attributes.learning_start_dt||"",learningDone:t.attributes.learning_done,allowKintBoost:t.attributes.allow_kint_boost_on_stagnation,allowKextCompensation:t.attributes.allow_kext_compensation_on_overshoot}:null}_getCurrentMaxCapacity(){const t=this.hass.states[this.config.learning_entity].attributes.max_capacity_heat;return null==t?"N/A":parseFloat(t).toFixed(2)}_toggleAutoTpi(t){this.hass&&this.config&&(t?this.hass.callService("versatile_thermostat","set_auto_tpi_mode",{entity_id:this.config.climate_entity,auto_tpi_mode:!1,reinitialise:!1}):this.hass.callService("versatile_thermostat","set_auto_tpi_mode",{entity_id:this.config.climate_entity,auto_tpi_mode:!0,reinitialise:this._resetChecked,allow_kint_boost_on_stagnation:this._boostKintChecked,allow_kext_compensation_on_overshoot:this._unboostKextChecked}),this._resetChecked=!1)}_toggleResetCheckbox(){this._resetChecked=!this._resetChecked,this.requestUpdate()}_toggleBoostKintCheckbox(){this._boostKintChecked=!this._boostKintChecked,this.requestUpdate()}_toggleUnboostKextCheckbox(){this._unboostKextChecked=!this._unboostKextChecked,this.requestUpdate()}_toggleOptions(){this._showOptions=!this._showOptions}_toggleHeating(){this._showHeating=!this._showHeating}_toggleSetpoint(){this._showSetpoint=!this._showSetpoint}_toggleKint(){this._showKint=!this._showKint}_toggleKext(){this._showKext=!this._showKext}_toggleExtTemp(){this._showExtTemp=!this._showExtTemp}_toggleMaxCapacity(){this._showMaxCapacity=!this._showMaxCapacity}_toggleTemp(){this._showTemp=!this._showTemp}_handleWheel(t){if(t.preventDefault(),!this._history)return;const e=t.currentTarget.getBoundingClientRect(),i=t.clientX-e.left,s=t.clientY-e.top,o=60,n=100,a=40,r=60,h=e.width-o-n,l=e.height-a-r,c=Math.max(0,Math.min(1,(i-o)/h)),p=this._history.endTime||Date.now(),d=this._history.startTime,_=Math.max(p-d,216e5),g=_/this._zoomLevel,u=d+this._panOffset+c*g,f=this._getYValueFromPosition(s,a,l),m=t.deltaY>0?.9:1.1,y=Math.max(1,Math.min(20,this._zoomLevel*m)),x=Math.max(1,Math.min(20,this._yZoomLevel*m));this._zoomLevel=y,this._yZoomLevel=x;const v=_/y;this._panOffset=u-d-c*v;const $=a+l/2,b=a+l-f*l;this._yPanOffset=s-($+(b-$)*this._yZoomLevel),1===this._zoomLevel&&(this._panOffset=0),1===this._yZoomLevel&&(this._yPanOffset=0),this._clampPanOffset(),this._tooltip=null,this.requestUpdate()}_zoomIn(){this._zoomLevel=Math.min(20,1.2*this._zoomLevel),this._yZoomLevel=Math.min(20,1.2*this._yZoomLevel),this._clampPanOffset(),this._clampYPanOffset(),this.requestUpdate()}_zoomOut(){this._zoomLevel=Math.max(1,this._zoomLevel/1.2),this._yZoomLevel=Math.max(1,this._yZoomLevel/1.2),1===this._zoomLevel&&(this._panOffset=0),1===this._yZoomLevel&&(this._yPanOffset=0),this._clampPanOffset(),this._clampYPanOffset(),this.requestUpdate()}_resetZoom(){this._zoomLevel=1,this._panOffset=0,this._yZoomLevel=1,this._yPanOffset=0}_clampPanOffset(){if(!this._history)return;const t=(this._history.endTime||Date.now())-this._history.startTime,e=Math.max(t,216e5),i=e-e/this._zoomLevel;this._panOffset=Math.max(0,Math.min(i,this._panOffset))}_clampYPanOffset(){this._yPanOffset=Math.max(-1e4,Math.min(1e4,this._yPanOffset))}_applyYZoom(t,e,i){if(1===this._yZoomLevel&&0===this._yPanOffset)return t;const s=e+i/2;return s+(t-s)*this._yZoomLevel+this._yPanOffset}_getYValueFromPosition(t,e,i){const s=e+i/2;return(e+i-(s+(t-this._yPanOffset-s)/this._yZoomLevel))/i}_getSVGPoint(t,e,i){const s=t.createSVGPoint();return s.x=e,s.y=i,s.matrixTransform(t.getScreenCTM().inverse())}_handleTouchMove(t){t.preventDefault();const e=t.currentTarget,i=t.touches[0],{x:s,y:o}=this._getSVGPoint(e,i.clientX,i.clientY);this._processCursorMove(s,o)}_handleMouseMove(t){const e=t.currentTarget,{x:i,y:s}=this._getSVGPoint(e,t.clientX,t.clientY);this._processCursorMove(i,s)}_handleMouseDown(t){this._isDragging=!0,this._dragStartX=t.clientX,this._dragStartY=t.clientY,this._dragStartOffset=this._panOffset,this._dragStartYOffset=this._yPanOffset,t.currentTarget.style.cursor="grabbing"}_handleMouseMove_Drag(t){if(!this._isDragging||!this._history)return;const e=60,i=100,s=t.currentTarget.getBoundingClientRect().width-e-i,o=this._dragStartX-t.clientX,n=this._dragStartY-t.clientY,a=this._history.endTime||Date.now(),r=this._history.startTime,h=o/s*(Math.max(a-r,216e5)/this._zoomLevel);this._panOffset=this._dragStartOffset+h,this._clampPanOffset(),this._yZoomLevel>1&&(this._yPanOffset=this._dragStartYOffset-n)}_handleMouseUp(t){this._isDragging=!1,t.currentTarget.style.cursor="default"}_handleTouchStart(t){if(1===t.touches.length)this._isDragging=!0,this._isPinching=!1,this._dragStartX=t.touches[0].clientX,this._dragStartY=t.touches[0].clientY,this._dragStartOffset=this._panOffset,this._dragStartYOffset=this._yPanOffset;else if(2===t.touches.length){this._isDragging=!1,this._isPinching=!0;const e=t.touches[0].clientX-t.touches[1].clientX,i=t.touches[0].clientY-t.touches[1].clientY;this._pinchStartDist=Math.hypot(e,i),this._pinchStartZoom=this._zoomLevel,this._pinchStartYZoom=this._yZoomLevel}}_handleTouchMove_Drag(t){if(!this._history)return;const e=t.currentTarget.getBoundingClientRect(),i=60,s=100,o=40,n=60,a=e.width-i-s,r=e.height-o-n;if(this._isDragging&&1===t.touches.length){t.preventDefault();const e=this._dragStartX-t.touches[0].clientX,i=this._dragStartY-t.touches[0].clientY,s=this._history.endTime||Date.now(),o=this._history.startTime,n=e/a*(Math.max(s-o,216e5)/this._zoomLevel);this._panOffset=this._dragStartOffset+n,this._clampPanOffset(),this._yZoomLevel>1&&(this._yPanOffset=this._dragStartYOffset-i)}else if(this._isPinching&&2===t.touches.length){t.preventDefault();const s=t.touches[0],n=t.touches[1],h=s.clientX-n.clientX,l=s.clientY-n.clientY,c=Math.hypot(h,l);if(this._pinchStartDist<=10)return;const p=c/this._pinchStartDist,d=(s.clientX+n.clientX)/2,_=(s.clientY+n.clientY)/2,g=d-e.left,u=_-e.top,f=Math.max(0,Math.min(1,(g-i)/a)),m=this._history.endTime||Date.now(),y=this._history.startTime,x=Math.max(m-y,216e5),v=x/this._zoomLevel,$=y+this._panOffset+f*v,b=this._getYValueFromPosition(u,o,r),w=Math.max(1,Math.min(20,this._pinchStartZoom*p)),k=Math.max(1,Math.min(20,this._pinchStartYZoom*p));this._zoomLevel=w,this._yZoomLevel=k;const S=x/w;this._panOffset=$-y-f*S;const C=o+r/2,M=o+r-b*r;this._yPanOffset=u-(C+(M-C)*this._yZoomLevel),1===this._zoomLevel&&(this._panOffset=0),1===this._yZoomLevel&&(this._yPanOffset=0),this._clampPanOffset(),this._clampYPanOffset(),this.requestUpdate()}}_handleTouchEnd(t){0===t.touches.length?(this._isDragging=!1,this._isPinching=!1):1===t.touches.length&&this._isPinching&&(this._isPinching=!1,this._isDragging=!0,this._dragStartX=t.touches[0].clientX,this._dragStartY=t.touches[0].clientY,this._dragStartOffset=this._panOffset,this._dragStartYOffset=this._yPanOffset)}_processCursorMove(t,e){if(!this._chartState)return;const{xMin:i,xMax:s,chartWidth:o,chartHeight:n,padding:a,kint:r,kext:h,temp:l,extTemp:c,setpoint:p,maxCapacity:d,getY_Kint:_,getY_Kext:g,getY_Temp:u,getY_MaxCapacity:f}=this._chartState,m=t-a.left;if(m<0||m>o)return void(this._tooltip=null);const y=i+m/o*(s-i),x=(t,e)=>{if(!t||0===t.length)return null;const i=this._bisectRight(t,e);return i>=0&&i<t.length?t[i].val:null},v=(t,e)=>{if(!t||0===t.length)return null;const i=this._bisectRight(t,e);if(i<0)return t[0].val;if(i>=t.length-1)return t[t.length-1].val;const s=t[i],o=t[i+1],n=s.t,a=o.t,r=s.val,h=o.val;if(a===n)return r;return r+(h-r)*((e-n)/(a-n))},$=this._showKint?x(r,y):null,b=this._showKext?x(h,y):null,w=this._showTemp?v(l,y):null,k=this._showExtTemp?v(c,y):null,S=this._showSetpoint?x(p,y):null,C=this._showMaxCapacity?v(d,y):null;let M=1/0,A=1/0,O=1/0,T=1/0,E=1/0,P=1/0;null!==$&&(M=_($)),null!==b&&(A=g(b)),null!==w&&(O=u(w)),null!==k&&(T=u(k)),null!==S&&(E=u(S)),null!==C&&(P=f(C));const L=Math.abs(e-M),D=Math.abs(e-A),z=Math.abs(e-O),Y=Math.abs(e-T),H=Math.abs(e-E),U=Math.abs(e-P);let K="kint",N=L;if(D<N&&(N=D,K="kext"),z<N&&(N=z,K="temp"),Y<N&&(N=Y,K="extTemp"),H<N&&(N=H,K="setpoint"),U<N&&(N=U,K="maxCapacity"),N>50)return void(this._tooltip=null);let R=$,F="var(--chart-color-kint)",Z="Coef INT",B=M,j=4;"kext"===K?(R=b,F="var(--chart-color-kext)",Z="Coef EXT",B=A):"temp"===K?(R=w,F="var(--chart-color-temp)",Z="Temp",B=O,j=1):"extTemp"===K?(R=k,F="var(--chart-color-ext-temp)",Z="Ext Temp",B=T,j=1):"setpoint"===K?(R=S,F="var(--chart-color-setpoint)",Z="Setpoint",B=E,j=1):"maxCapacity"===K&&(R=C,F="var(--chart-color-max-capacity)",Z="Heat Rate",B=P,j=2),this._tooltip=null!==R?{x:t,y:e,t:y,value:R,color:F,title:Z,targetY:B,precision:j}:null}_handleMouseLeave(){this._tooltip=null}_renderTooltip(){if(!this._tooltip||null===this._tooltip.value)return Z``;const t=new Date(this._tooltip.t).toLocaleString("fr-FR",{day:"numeric",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"}),{x:e,targetY:i}=this._tooltip,s=this._width>0?this._width:800,o=e>s/2;return Z`
    ...
    `}_calculateChartState(){if(!this._history)return null;const{kint:t,kext:e,temp:i,heating:s,setpoint:o,extTemp:n,maxCapacity:a}=this._history,r=this._width>0?this._width:800,h={top:10,right:100,bottom:40,left:60},l=r-h.left-h.right,c=300-h.top-h.bottom,p=this._history.endTime||Date.now();let d=this._history.startTime,_=p;const g=216e5,u=p-d;p-d<g&&(_=d+g);const f=Math.max(u,g)/this._zoomLevel;let m=d+this._panOffset,y=m+f;let x=0,v=1;if(t.length>0){let e=1/0,i=-1/0;for(const s of t)s.val<e&&(e=s.val),s.val>i&&(i=s.val);x=Math.min(0,e),v=Math.max(1,i),v>1&&(v=Math.ceil(10*v)/10)}let $=0,b=.1;if(e.length>0){let t=1/0,i=-1/0;for(const s of e)s.val<t&&(t=s.val),s.val>i&&(i=s.val);$=Math.min(0,t),b=Math.max(.1,i),b>.1&&(b=Math.ceil(100*b)/100)}let w=-20,k=40;const S=[...i,...n,...o];if(S.length>0){const t=Math.min(...S.map(t=>t.val)),e=Math.max(...S.map(t=>t.val));if(w=Math.max(-20,Math.floor(t-1)),k=Math.min(40,Math.ceil(e+1)),k-w<5){const t=(w+k)/2;w=Math.max(-20,t-2.5),k=Math.min(40,t+2.5)}}let C=0,M=1;if(a.length>0){const t=Math.min(...a.map(t=>t.val)),e=Math.max(...a.map(t=>t.val));if(C=Math.max(0,Math.floor(t-.5)),M=Math.min(10,Math.ceil(e+.5)),M-C<1){const t=(C+M)/2;C=Math.max(0,t-.5),M=Math.min(10,t+.5)}}return{width:r,height:300,padding:h,chartWidth:l,chartHeight:c,xMin:m,xMax:y,getX:t=>y===m?h.left:h.left+(t-m)/(y-m)*l,getY_Kint:t=>{const e=h.top+c-(t-x)/(v-x)*c;return this._applyYZoom(e,h.top,c)},getY_Kext:t=>{const e=h.top+c-(t-$)/(b-$)*c;return this._applyYZoom(e,h.top,c)},getY_Temp:t=>{if(k===w)return h.top+c/2;const e=h.top+c-(t-w)/(k-w)*c;return this._applyYZoom(e,h.top,c)},getY_MaxCapacity:t=>{if(M===C)return h.top+c/2;const e=h.top+c-(t-C)/(M-C)*c;return this._applyYZoom(e,h.top,c)},kintMin:x,kintMax:v,kextMin:$,kextMax:b,maxCapacityMin:C,maxCapacityMax:M,kint:t,kext:e,temp:i,heating:s,setpoint:o,extTemp:n,maxCapacity:a}}_generateStaticContent(t){if(!t)return B``;const{width:e,height:i,padding:s,chartWidth:o,chartHeight:n,xMin:a,xMax:r,getX:h,getY_Kint:l,getY_Kext:c,getY_Temp:p,getY_MaxCapacity:d,kintMin:_,kintMax:g,kextMin:u,kextMax:f,maxCapacityMin:m,maxCapacityMax:y,kint:x,kext:v,temp:$,heating:b,setpoint:w,extTemp:k,maxCapacity:S}=t,C=(t,e)=>0===t.length?"":t.map((t,i)=>`${0===i?"M":"L"} ${h(t.t).toFixed(1)},${e(t.val).toFixed(1)}`).join(" "),M=(t,e)=>{if(0===t.length)return"";let i=`M ${h(t[0].t).toFixed(1)},${e(t[0].val).toFixed(1)}`;for(let s=0;s<t.length-1;s++){const o=t[s],n=t[s+1];i+=` L ${h(n.t).toFixed(1)},${e(o.val).toFixed(1)}`,i+=` L ${h(n.t).toFixed(1)},${e(n.val).toFixed(1)}`}const s=t[t.length-1],o=this._history?.endTime||Date.now();return o>s.t&&(i+=` L ${h(o).toFixed(1)},${e(s.val).toFixed(1)}`),i},A=this._showKint?this._getVisibleData(x,a,r):[],O=this._showKext?this._getVisibleData(v,a,r):[],T=this._showTemp?this._getVisibleData($,a,r):[],E=this._showExtTemp?this._getVisibleData(k,a,r):[],P=this._showSetpoint?this._getVisibleData(w,a,r):[],L=this._showMaxCapacity?this._getVisibleData(S,a,r):[],D=A.length>0?M(A,l):"",z=O.length>0?M(O,c):"",Y=T.length>0?C(T,p):"",H=E.length>0?C(E,p):"",U=P.length>0?M(P,p):"",K=P.length>0?((t,e)=>{if(0===t.length)return"";let i=`M ${h(t[0].t).toFixed(1)},${s.top+n}`;for(let s=0;s<t.length-1;s++){const o=t[s],n=t[s+1];i+=` L ${h(n.t).toFixed(1)},${e(o.val).toFixed(1)}`,i+=` L ${h(n.t).toFixed(1)},${e(n.val).toFixed(1)}`}const o=t[t.length-1],a=this._history?.endTime||Date.now();return a>o.t&&(i+=` L ${h(a).toFixed(1)},${e(o.val).toFixed(1)}`),i+=` L ${h(t[t.length-1].t).toFixed(1)},${s.top+n}`,i+=` L ${h(t[0].t).toFixed(1)},${s.top+n} Z`,i})(P,p):"",N=L.length>0?C(L,d):"",R=[];if(this._showHeating&&b.length>0){const t=e-s.right;let i=this._bisectLeft(b,a),o=this._bisectRight(b,r);i=Math.max(0,i-1),o=Math.min(b.length-1,o+1);for(let e=i;e<=o;e++)if(b[e]&&1===b[e].val){const i=b[e].t,o=e<b.length-1?b[e+1].t:this._history?.endTime||Date.now();if(o<a||i>r)continue;const l=h(i),c=h(o),p=Math.max(s.left,Math.min(l,c)),d=Math.min(t,Math.max(l,c))-p;d>0&&R.push(B`
              <rect
                x="${p}"
                y="${s.top+n-20}"
                width="${d}"
              ...
              />
            `)}}const F=[],Z=g>2?.5:.25;for(let t=Math.ceil(_/Z)*Z;t<=g+.001;t+=Z)F.push(t);const j=F.map(t=>{const i=l(t);return B`
        <line x1="${s.left}" y1="${i}" x2="${e-s.right}" y2="${i}" stroke="var(--chart-color-grid)" stroke-width="1" opacity="0.3" />
        <text x="${s.left-8}" y="${i+5}" text-anchor="end" font-size="12" fill="var(--chart-color-kint)" opacity="0.9">${t.toFixed(2)}</text>
      `}),X=[],V=f>.5?.1:.05;for(let t=Math.ceil(u/V)*V;t<=f+1e-4;t+=V)X.push(t);const I=X.map(t=>{const i=c(t);return B`
        <text x="${e-s.right+8}" y="${i+5}" text-anchor="start" font-size="12" fill="var(--chart-color-kext)" opacity="0.9">${t.toFixed(2)}</text>
      `}),W=[],q=y>2?1:.5;for(let t=Math.ceil(m/q)*q;t<=y+.001;t+=q)W.push(t);const G=W.map(t=>{const i=d(t);return B`
        <line x1="${s.left}" y1="${i}" x2="${e-s.right}" y2="${i}" stroke="var(--chart-color-grid)" stroke-width="1" opacity="0.2" />
        <text x="${e-s.right+42}" y="${i+5}" text-anchor="start" font-size="12" fill="var(--chart-color-max-capacity)" opacity="0.9">${t.toFixed(1)}</text>
      `}),J=[],Q=(r-a)/5,tt=[36e5,72e5,108e5,144e5,216e5,432e5,864e5];let et=tt.find(t=>Q<=t)||tt[tt.length-1];const it=new Date(a);it.setMinutes(0,0,0),it.getTime()<a&&it.setTime(it.getTime()+36e5);let st=it.getTime();for(;st<=r;){const t=new Date(st),e=t.getHours();if(e%(et/36e5)===0){const o=h(st),a=`${t.getHours().toString().padStart(2,"0")}:${t.getMinutes().toString().padStart(2,"0")}`;let r="";if(0===e){const e={day:"numeric",month:"short"};r=t.toLocaleDateString("fr-FR",e)}J.push(B`
          <line x1="${o}" y1="${s.top+n}" x2="${o}" y2="${s.top+n+5}" stroke="var(--chart-color-time-label)" stroke-width="1" />
          <text x="${o}" y="${i-18}" text-anchor="middle" font-size="12" fill="var(--chart-color-time-label)">${a}</text>
          ${r?B`<text x="${o}" y="${i-4}" text-anchor="middle" font-size="10" fill="var(--chart-color-sub-label)">${r}</text>`:""}
        `)}st+=36e5}return B`
      <defs>
      ...
      <rect x="${s.left}" y="${s.top}" width="${o}" height="${n}" fill="transparent" stroke="var(--chart-color-grid)" stroke-width="1" opacity="0.5" />

      ${R}
      ${K?B`<path d="${K}" fill="var(--chart-color-setpoint-fill)" stroke="none" style="pointer-events: none;" clip-path="url(#chart-clip)" />`:""}
      ${U?B`<path d="${U}" fill="none" stroke="var(--chart-color-setpoint)" stroke-width="2" style="pointer-events: none;" clip-path="url(#chart-clip)" />`:""}
      ${Y?B`<path d="${Y}" fill="none" stroke="var(--chart-color-temp)" stroke-width="1.5" opacity="0.7" style="pointer-events: none;" clip-path="url(#chart-clip)" />`:""}
      ${H?B`<path d="${H}" fill="none" stroke="var(--chart-color-ext-temp)" stroke-width="1.5" opacity="0.9" style="pointer-events: none;" clip-path="url(#chart-clip)" />`:""}
      ${N?B`<path d="${N}" fill="none" stroke="var(--chart-color-max-capacity)" stroke-width="2" stroke-dasharray="5,5" style="pointer-events: none;" clip-path="url(#chart-clip)" />`:""}
      ${z?B`<path d="${z}" fill="none" stroke="var(--chart-color-kext)" stroke-width="2" style="pointer-events: none;" clip-path="url(#chart-clip)" />`:""}
      ${D?B`<path d="${D}" fill="none" stroke="var(--chart-color-kint)" stroke-width="2.5" style="pointer-events: none;" clip-path="url(#chart-clip)" />`:""}
        ...
        <div class="card-content">
          ...
          <div class="legend">
            ...
            <div class="legend-item clickable" @click="${()=>this._toggleMaxCapacity()}">
              <span class="dot max-capacity-bg" style="opacity: ${this._showMaxCapacity?1:.3}"></span> Hrate
            </div>
            <div class="legend-item clickable" @click="${()=>this._toggleSetpoint()}">
              <span class="dot setpoint-bg" style="opacity: ${this._showSetpoint?1:.3}"></span> SPoint
            </div>
            <div class="legend-item clickable" @click="${()=>this._toggleExtTemp()}">
              <span class="dot ext-temp-bg" style="opacity: ${this._showExtTemp?1:.3}"></span> ExTemp
            </div>
            ...
            <div class="legend-item clickable" @click="${()=>this._toggleHeating()}">
              <span class="dot heating-bg" style="opacity: ${this._showHeating?1:.3}"></span> Heat
            </div>
          </div>
        </div>
      </ha-card>
  ...
  `}customElements.get("auto-tpi-learning-card")||customElements.define("auto-tpi-learning-card",ct);class pt extends ht{static properties={hass:{type:Object},config:{type:Object}};setConfig(t){this.config=t}_findLearningSensor(t){if(!this.hass||!t)return null;const e=t.replace("climate.",""),i=`sensor.${e}_auto_tpi_learning_state`;if(this.hass.states[i])return i;return Object.keys(this.hass.states).find(t=>t.startsWith("sensor.")&&t.includes(e)&&t.endsWith("_auto_tpi_learning_state"))||null}_climateChanged(t){const e=t.detail.value,i={...this.config};i.climate_entity=e;const s=this._findLearningSensor(e);if(s&&(i.learning_entity=s),!i.name&&e){const t=e.replace("climate.","").replace(/_/g," ");i.name=t.charAt(0).toUpperCase()+t.slice(1)}this._fireConfigChanged(i)}_learningChanged(t){const e={...this.config};e.learning_entity=t.detail.value,this._fireConfigChanged(e)}_nameChanged(t){const e={...this.config};e.name=t.target.value,this._fireConfigChanged(e)}_fireConfigChanged(t){const e=new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0});this.dispatchEvent(e)}_getLearningSensors(){return this.hass?Object.keys(this.hass.states).filter(t=>t.startsWith("sensor.")&&t.endsWith("_auto_tpi_learning_state")):[]}render(){return this.hass&&this.config?Z`
  ...
  `}customElements.get("auto-tpi-learning-card-editor")||customElements.define("auto-tpi-learning-card-editor",pt),window.customCards=window.customCards||[],window.customCards.some(t=>"auto-tpi-learning-card"===t.type)||window.customCards.push({type:"auto-tpi-learning-card",name:"Auto-TPI Learning Card",description:"Visualization of Versatile Thermostat Auto-TPI learning process"});
